...
3. Modify the connection string in the web.config file according to the database server you are using for testing.
...
5. To test the get method in the web service, you can use the file /documents/WebService_Test.html . This file contains a ajax instruction to get 
   the transaction with id 2
